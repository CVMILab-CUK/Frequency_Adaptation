...
\begin{axis}[draft, height=32mm,
  ...
  % curve.dat rows are ordered r = 0, 0.05, 0.1, 0.2, 0.3, 0.5, 0.7, 1; rows 1-4
  % are the claimed range. Split by row index because an expression filter on
  % \thisrow{r} does not survive pgfplots' parser here.
