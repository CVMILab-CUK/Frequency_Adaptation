...
structure-consistency / FID plane. Narrowing the condition's bandwidth lowers
structure consistency within a narrow FID band; weakening either adapter lowers
it while FID rises. Scaled points are scored at $r_m{=}0.1$, cutoff points at
their own cutoff. Both panels are plotted directly from the evaluation
outputs.}
\label{fig:curve}
\end{figure}
