...
\begin{axis}[draft, height=42mm,
  xlabel={cutoff $r$}, ylabel={condition retained},
...
condition re-extracted after an encode--decode round trip, 24 images. Above
$r{\approx}0.5$ the condition is effectively gone, so an adapter reading the VAE
latent cannot recover it. Building the condition at 256 and upsampling puts the
